...
import Repaso_ExamenRecuperacion_2025.Herencias.interfaces.Lanzar;

import java.util.HashSet;
import java.util.Set;

public class Mago extends Personaje implements Lanzar {
    ...
    public Set<String> getNombreHechizos() {
        return nombreHechizos;
    }
    ...
    public void lanzarHechizo(Personaje personaje, String hechizo) throws JuegoRolException {
        ...
        setPuntoVidaActual_personaje(vidaActualDañada);
